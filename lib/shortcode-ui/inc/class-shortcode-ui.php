...
class Shortcode_UI {
	...
	private function __construct() {
		...
		$this->plugin_dir     =  get_template_directory().'/lib/shortcode-ui/' ;
		$this->plugin_url     =  get_template_directory_uri().'/lib/shortcode-ui/' ;
	}
	...
	public function enqueue() {
		...
		wp_localize_script( 'shortcode-ui', ' shortcodeUIData', array(
			...
			'strings'         => array(
				'media_frame_title'                 => __( 'Insert Shortcode', 'shortcode-ui' ),
				'media_frame_menu_insert_label'     => __( 'Insert Shortcode', 'shortcode-ui' ),
				'media_frame_menu_update_label'     => __( '%s Details', 'shortcode-ui' ), // Substituted in JS
				'media_frame_toolbar_insert_label'  => __( 'Insert Shortcode', 'shortcode-ui' ),
				'media_frame_toolbar_update_label'  => __( 'Update', 'shortcode-ui' ),
				'media_frame_no_attributes_message' => __( 'There are no attributes to configure for this Shortcode.', 'shortcode-ui' ),
	...
	/**
	 * Output an "Add Shortcode" button with the media buttons.
	 */
	public function action_media_buttons( $editor_id ) {
		printf( '<button type="button" class="button shortcake-add-post-element" data-editor="%s">' .
			...
			'</button>',
			esc_attr( $editor_id ),
			esc_html__( 'Add Shortcode', 'shortcode-ui' )
		);
	}
